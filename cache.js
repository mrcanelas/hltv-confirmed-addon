...
const GLOBAL_KEY_PREFIX = 'hltv-confirmed';
const META_KEY_PREFIX = `${GLOBAL_KEY_PREFIX}|meta`;
const META_KEY_POSTER = `${GLOBAL_KEY_PREFIX}|poster`;
...
function cacheWrapPoster(id, method) {
  return cacheWrap(`${META_KEY_POSTER}:${id}`, method, { ttl: META_TTL });
}

module.exports = { cacheWrapCatalog, cacheWrapMeta, cacheWrapPoster };